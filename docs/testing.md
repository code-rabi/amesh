...
- The Go daemon owns table-driven tests for config loading, reconnect logic, command env wiring, and `acpx` process lifecycle including streamed output and cancellation.
